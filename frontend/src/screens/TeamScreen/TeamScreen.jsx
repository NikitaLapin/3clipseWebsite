...
const TeamScreen = () => {
    const[team, setTeam] = useState([
        ...
        {name: 'Mikhail Malyshev', job: 'Technical Developer', src: require('./imports/Ishax.jpg')},
        {name: 'Alexander Ukhouv', job: 'Game Designer', src: require('./imports/Ishax2.jpg')},
    ...
    return (
        <div className='black-box'>
            ...
            <TeamList team={team}/>
            <b className='inspire-text'>Our game was inspired by such projects as Berserk, Dark Souls, Diablo, Magicka, Gothic</b>
